...
public :
	...
	void attackActionByTargetPosition(Vec2 direcVector, int attackTime, AttackCallback oneSecondCallback = nullptr,  AttackCallback animationCallback = nullptr, bool removeFollowActionFlg = false);
	void respawAction();
	void stopMoveAction();
